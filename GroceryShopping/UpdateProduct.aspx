<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateProduct.aspx.cs" Inherits="GroceryShopping.UpdateProduct" %>
                        ...
                        <div class="login-wrap">
                            <div class="login-content">
                                <div class="login-logo">
                                    <a href="#">UPDATE<span>PRODUCT</span></a>
                                </div>
                                <div class="login-form">
                                    ...
                                    <asp:Button ID="btnAddProduct" runat="server" CssClass="au-btn au-btn--block au-btn--green m-b-20" Text="Update" OnClick="btnUpdateProduct_Click" />
